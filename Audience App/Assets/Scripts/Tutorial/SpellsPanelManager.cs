...
namespace audience.tutorial
{
    public class SpellsPanelManager : APanelManager
    {
        ...
        {
            var spellManager = Instantiate(_SelectionPanel, _Canvas.transform).GetComponent<SpellsPanelManager>();
        }

        public void PreviousPage()
        {
            var spellManager = Instantiate(_PrimaryPanel, _Canvas.transform).GetComponent<PrimaryPanelManager>();
        }
